...
CATEGORIES = {
    ...
    "💰 Economy": {
        ...
        "commands": [
            ...
            ("/overtime",            "⏰", "Илүү цагаар ажиллах — 2ц cooldown, 2x цалин, аз жаргал -3"),
            ("/daily",               "🎁", "Өдөр тутмын урамшуулал авах (24 цаг cooldown)"),
            ("/transfer @хүн <дүн>", "💸", "Өөр хүнд мөнгө шилжүүлэх"),
            ("/shop [категори]",     "🏪", "Дэлгүүр харах — food / alcohol / gem / vehicle г.м"),
    ...
    "📈 Хөрөнгө оруулалт": {
        "emoji": "📈",
        "description": "Мөнгөө хөрөнгө оруулалтад байршуулж ашиг олох",
        "commands": [
            ("/invest <дүн>",        "💹", "10,000–5,000,000 ₮ байршуулах — 12 цагт 8% ашиг"),
            ("/collectinvest",       "💰", "12 цаг дууссан бол хөрөнгө + ашгаа авах"),
        ],
    },
    "🏦 Банк": {
        "emoji": "🏦",
    ...
    "⚔️ Тоглоом": {
        ...
        "commands": [
            ...
            ("/slot <бооцоо>",               "🎰", "Slot machine — 1.5x / 🔥1M+ бол 2x (2 ижил)"),
            ("/coinflip <сонголт> <бооцоо>", "🪙", "Зоос шидэх — 50/50 | <1M=1.7x / 🔥1M+=2x"),
            ("/rps <сонголт> <бооцоо>",      "✂️", "Чулуу-Цаас-Хайч — bot-той тоглох, 1.5x"),
            ("/roulette <тавил> <бооцоо>",   "🎡", "Рулетка — 🔴хар/улаан 1.7x | 🟢ногоон(0) 25x | 🎯тоо 30x | 🔥1M+=2x"),
    ...
    "🛡️ Admin": {
        ...
        "commands": [
            ...
            ("/setvirtualchild @эцэг @эх",       "👫", "Гэрлэсэн хосод виртуал хүүхэд нэмэх"),
            ("/admingivechild @хүн",             "👶", "Ганц хүнд виртуал хүүхэд оноох"),
            ("/adminremovechild <ID>",           "🗑️", "Виртуал хүүхдийг ID-аар устгах"),
            ("/adminkill @хүн",                  "💀", "Бүх DB мэдээллийг бүрэн устгах"),
        ],
    },
}
